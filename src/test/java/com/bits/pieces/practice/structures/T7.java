...
//        add(new int[][] {{0, 30}, {5, 10}, {15, 20}}); add(new int[][]{{7, 10}, {2, 4}}); add(new int[][]{{0, 5}, {6, 10}, {15, 20}, {25, 26}, {27, 30}}); add(new int[][]{{0, 30}, {5, 25}, {10, 20}, {15, 19}, {35, 40}}); add(new int[][]{{1, 5}, {5, 10}}); add(new int[][]{{1, 5}, {8, 9}, {8, 9}}); add(new int[][]{{9, 14}, {5, 6}, {3, 5}, {12, 19}}); add(new int[][]{{0, 30}, {5, 10}, {15, 20}, {10, 15}});
    }};
